<!-- list the differences of orgUnit between two programmes hmis vs malaria -->
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
  ...
  <body>
    <?php
    define("HMIS_DB", "hmis_09jun2016");
    define("MALARIA_DB", "malaria_09jun2016");
      ...
      foreach ($hmis_org as $hmis_value) {
        foreach ($malaria_org as $malaria_value) {
          if ($hmis_value[id] == $malaria_value[id] ) {
            $flag++;
            break;
          }
        }
      ...
      foreach ($malaria_org as $malaria_value) {
        ...
        if ($flag == 0) {
          array_push($inMalariaNotHmis, $malaria_value);
